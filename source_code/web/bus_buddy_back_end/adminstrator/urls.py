...
urlpatterns = [
    ...
    path("deactivate-coupon/<int:coupon_id>/",views.DeactivateCoupon.as_view(),name="deactivate_coupon"),
    path("activate-coupon/<int:coupon_id>/",views.ActivateCoupon.as_view(),name="activate_coupon"),
]
