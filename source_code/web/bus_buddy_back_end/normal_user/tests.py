...
class UpdateUserTest(BaseTest):
    def test_can_update_user(self):
        ...
        response = self.client.put(
            reverse("update-profile"), self.update_valid_all_values, format="json"
        )
    ...
    def test_cant_update_user_with_invalid_names(self):
        print("13")
        response = self.client.put(
            reverse("update-profile"), self.invalid_names, format="json"
        )
        self.assertEqual(response.status_code, 400)
    ...
    def test_cant_update_user_with_invalid_phone_length(self):
        print("14")
        response = self.client.put(
            reverse("update-profile"), self.invalid_phone_length, format="json"
        )
        self.assertEqual(response.status_code, 400)
    ...
    def test_cant_update_user_with_invalid_phone_alphabet(self):
        print("15")
        response = self.client.put(
            reverse("update-profile"), self.invalid_phone_alphabet, format="json"
        )
        self.assertEqual(response.status_code, 400)
