...
from .models import SeatDetails, Bus, Routes, Amenities
from account_manage.models import User

from .serializer import OwnerModelSerializer as OMS
from .serializer import OwnerDataSerializer as ODS
