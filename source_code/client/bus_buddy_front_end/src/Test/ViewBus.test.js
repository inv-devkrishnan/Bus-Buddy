...
describe("View bus component", () => {
    it("renders component", async() => {
      ...
      const deleteData = {
        ...
        mock.onGet(`bus-owner/view-bus/?page=${1}&search=${""}&filter=${3}`).reply(200, data);
        ...
        const filterByButtonAll = screen.getByText("All");
        fireEvent.click(filterByButtonAll);
...
it("renders component modal cancel", async() => {
    const data = {
      "page_size": 15,
      "total_objects": 5,
      "total_pages": 1,
  ...
  const deleteData = {
    ...
    const filterByButtonNotcompleted = screen.getByText("Details not completed");
    fireEvent.click(filterByButtonNotcompleted);

    const filterByButtonPartialCompleted = screen.getByText("Partial completed");
    fireEvent.click(filterByButtonPartialCompleted);
  ...
  it("renders component enable", async() => {
    const data = {
      "page_size": 15,
      "total_objects": 5,
      "total_pages": 1,
  ...
  const deleteData = {
    ...
    mock.onGet(`bus-owner/view-bus/?page=${1}&search=${""}&filter=${3}`).reply(200, data);
    mock.onPut(`bus-owner/delete-bus/${9}/`).reply(200, deleteData);
    mock.onPut(`bus-owner/enable-bus/${9}/`).reply(200, deleteData);
    ...
    const filterByButtonEnable= screen.getByText("Disabled Buses");
    fireEvent.click(filterByButtonEnable);
