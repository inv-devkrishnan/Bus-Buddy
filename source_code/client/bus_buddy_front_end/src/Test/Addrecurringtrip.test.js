...
describe("Add Recurring Trip component", () => {
  ...
  it("renders component error", async () => {
    ...
    mock
      .onGet(
        `bus-owner/view-available-bus/?start=${"2024-01-16"}&end=${"2024-01-02"}`
      )
      .reply(200, data);
    render(
      <MemoryRouter>
  ...
  it("renders component error date", async () => {
    const data = [
      {
        id: 1,
        bus_name: "Sera",
    ...
    mock
      .onGet(
        `bus-owner/view-available-bus/?start=${"202-01-16"}&end=${"2024-01-02"}`
      )
      .reply(200, data);
    render(
      <MemoryRouter>
