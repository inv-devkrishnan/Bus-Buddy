...
describe("View Route component", () => {
  ...
  it("renders component modal api fail",async () => {
    const data = {
      "page_size": 15,
      "total_objects": 3,
      "total_pages": 1,
  ...
  mock.onPut(`bus-owner/delete-routes/${3}/`).reply(200, deleteData);
    ...
    mock.onGet(`bus-owner/pick-and-drop-stops/${3}/`).reply(400, data);
    await new Promise(resolve => setTimeout(resolve, 2000));
...
it("renders component modal success",async () => {
  ...
  it("renders component url error",async () => {
    const data = {
      "page_size": 15,
      "total_objects": 3,
      "total_pages": 1,
  ...
  mock.onGet(`bus-owner/view-routes/?page=${1}&search=${""}&ordering=${3}`).reply(400, data);
  mock.onPut(`bus-owner/delete-routes/${3}/`).reply(200, deleteData);
