...
describe("ComplaintCard component", () => {
  ...
  it("delete coupon", () => {
    renderDeleteCoupon();
    mock
      .onPut(`adminstrator/delete-coupon/1/`)
      .reply(200, { success_code: "1025" });
  });
  ...
  it("delete coupon fail 2", () => {
    ...
    mock
      .onPut(`adminstrator/delete-coupon/1/`)
      .reply(200, { error_code: "1025" });
  });

  it("dectivate coupon", () => {
    renderDeactivateCoupon();
    mock
      .onPut(`adminstrator/deactivate-coupon/1/`)
      .reply(200, { success_code: "1025" });
  });
  ...
  it("activate coupon", () => {
    renderActivateCoupon();
    mock
      .onPut(`adminstrator/activate-coupon/2/`)
      .reply(200, { success_code: "1025" });
  });
