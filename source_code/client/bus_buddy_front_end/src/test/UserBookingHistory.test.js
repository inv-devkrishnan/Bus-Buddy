...
describe("UserBookingHistory component", () => {
  ...
  it("getting booking data and no booking data", async () => {
    const data = {};
    mock.onGet("user/booking-history?page=1&&status=0").reply(200, data);

    render(<UserBookingHistory />);
  });

  it("getting booking data and viewing policy", async () => {
    const data = {
      page_size: 5,
      total_objects: 1,
      total_pages: 1,
    ...
    const policyButton = screen.getByText("View Refund Policy");
    fireEvent.click(policyButton);

    const policyCloseButton = screen.getByText("Close");
    fireEvent.click(policyCloseButton);
  });

  it("getting booking data and cancelling booking", async () => {
    const data = {
      page_size: 5,
      total_objects: 1,
      total_pages: 1,
    ...
    mock.onPut("user/cancel-booking/?booking_id=25").reply(200, {
      message: "Booking cancelled successfully",
      email: "mail send successfully",
      code: "D2007",
    });
  });

  it("getting booking data and cancelling booking failed", async () => {
    const data = {
      page_size: 5,
      total_objects: 1,
      total_pages: 1,
    ...
    mock.onPut("user/cancel-booking/?booking_id=25").reply(400);
  });

  it("getting booking data and cancelling booking partial", async () => {
    const data = {
      page_size: 5,
      total_objects: 1,
      total_pages: 1,
    ...
    mock.onPut("user/cancel-booking/?booking_id=25").reply(200, {
      message: "Cancelled Successfully, partial Refund has been initiated",
      email: "mail send successfully",
      code: "D2009",
    });
  });

  it("getting booking data and cancelling booking mail error", async () => {
    const data = {
      page_size: 5,
      total_objects: 1,
      total_pages: 1,
    ...
    mock.onPut("user/cancel-booking/?booking_id=25").reply(200, {
      ...
      email: "mail send error",
      code: "D2008",
    });
  });

  it("getting booking data and cancelling booking failed error", async () => {
    const data = {
      page_size: 5,
      total_objects: 1,
      total_pages: 1,
    ...
    mock.onPut("user/cancel-booking/?booking_id=25").reply(200, {
      ...
      email: "mail send failed",
      code: "",
    });
  });

  it("getting booking data and review", async () => {
    const data = {
      page_size: 5,
      total_objects: 1,
      total_pages: 1,
    ...
    mock.onGet("user/booking-history?page=1&&status=").reply(200, newData);
  });
});
